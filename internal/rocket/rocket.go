//go:generate mockgen --destination=rocket_mocks_test.go -package=rocket github.com/wfen/go-grpc-services-course/internal/rocket Store
package rocket

import "context"

// Rocket - should contain the definitions of our
// rocket
type Rocket struct {
	ID      string
	Name    string
...
// GetRocketByID - retrieves our rocket based on the ID from the store
